...
class pdf_crabe extends ModelePDFFactures
{
	...
	function __construct($db)
	{
		...
		//  aqui va el comprobante X 
		
		$this->comprobante= "valor de prueba";
	}
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		// Comprobante de venta X     ------===================================================================================================================================
		if ($this->comprobante != "")
		{

			$posy+=6;
			$pdf->SetXY(75,10);        // seteo el origen de coordenadas
			$pdf->SetTextColor(0,0,60);  // color del texto 

			// Set font
			$pdf->SetFont('','B',27);		// tamaño de letra y tipo Negrita
			// Move to 8 cm to the right
			$pdf->SetLineWidth(0.3);
			$pdf->Line(105, 0, 105, 10);    // dibujo una linea 
			$pdf->Cell(20);					// creo la celda 
			// Texto centrado en una celda con cuadro 20*10 mm y salto de línea
			$pdf->Cell(20,10,'X',1,1,'C');	


			//$pdf->MultiCell(40, 20, $this->comprobante , '1', 'C');
