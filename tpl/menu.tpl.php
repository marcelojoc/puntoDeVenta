...
print '<ul class="menu">';
// Link to new sell
print '<li class="menu_choix1"><a href="select_client.php"><span>'.$langs->trans("NewSell").'</span></a></li>';
...
print $langs->trans("CashDeskThirdParty").': '.$company->name_alias.'<br>';
